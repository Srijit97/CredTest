...
class SeekArc : View {
     ...
     */
    private var mProgressWidth = 6

    /**
     * The Width of the background arc for the SeekArc
     */
    private var mArcWidth = 20
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyle: Int) {
        ...
        var arcColor = res.getColor(R.color.progressBackgroundColor)
        var progressColor = res.getColor(R.color.progressColor)
        var thumbHalfheight: Int
        var thumbHalfWidth = 0
        mThumb = res.getDrawable(R.drawable.ic_money_bag)
